...
<main class="min-h-screen relative overflow-hidden flex items-center justify-center">
	...
	<div class="absolute inset-0 pointer-events-none overflow-hidden">
		<div
			class="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-primary/5 blur-3xl"
			style="transform: translateY({floatY * 0.5}px)"
		></div>
		<div
			class="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-primary/5 blur-3xl"
			style="transform: translateY({floatY * -0.3}px)"
		></div>
	</div>
	...
	<div class="container mx-auto px-4 relative z-10">
		<div class="max-w-4xl mx-auto text-center">
			...
			<div
				...
				in:fly={{ y: -50, opacity: 0, duration: 800, easing: quintOut }}
			>
				<h1 class="text-[12rem] md:text-[16rem] lg:text-[20rem] font-semibold leading-none tracking-tighter">
					{statusCode}
				</h1>

				<!-- Decorative elements around error code -->
				<div class="absolute top-0 left-0 w-16 h-16 border-l-2 border-t-2 border-primary/30"></div>
				<div
				...
				<div
					...
					in:blur={{ amount: 10, delay: 400, duration: 800 }}
				>
			...
			<!-- Message -->
			<div
				in:fly={{ y: 30, opacity: 0, delay: 200, duration: 800, easing: quintOut }}
			>
				<div class="mb-6">
					<span class="badge-accent">{badgeText()}</span>
				</div>
				<h2
					class="text-2xl md:text-3xl lg:text-4xl font-medium mb-6 leading-relaxed"
			...
			<div
				...
				in:fly={{ x: -20, opacity: 0, delay: 400, duration: 600 }}
			></div>
			...
			<div
				...
				in:blur={{ amount: 5, delay: 800, duration: 800 }}
			>
				...
				<div class="space-y-3">
					...
					>
						...
						<div class="flex-1">
							<div class="font-medium group-hover:text-primary transition-colors mb-1">Blog Articles</div>
					...
					>
						...
						<div class="flex-1">
							<div class="font-medium group-hover:text-primary transition-colors mb-1">Homepage</div>
			...
			<!-- Zen quote -->
			<div
				class="mt-12 text-muted-foreground/60 text-sm italic"
